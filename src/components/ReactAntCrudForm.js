...
import { Card, Spin, Form, Input, InputNumber, Switch, Button, Radio, Select, DatePicker } from 'antd' // Popconfirm, Icon
...
function ReactAndCrudForm(props) {
  ...
  return (
    <Card
      bodyStyle={{padding: 8}}
      title={props.mode === 'add' ? 'Add' : 'Update'}
    >
      <Spin spinning={props.loading}>
        <Form onSubmit={handleSubmit} style={{ padding: 16 }}>
          ...
          {props.formType !== 'filter' ? <Form.Item>
            <Button styletype="primary" htmlType="submit">{props.mode === 'add' ? 'Add' : 'Update'}</Button>
